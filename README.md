...
* 영화를 소개하기 위해 또는 영화 감상평을 쓰기 위해 영화 포스터를 사용하는 것은 저작권법 위반이 아니다. 이렇게 사용하는 것은 허용되어 있는 사용범위에 속한다. 굳이 저작권자를 찾아서 사용허락을 받을 필요도 없다. 저작권 28조에서 정당한 인용의 방식으로 사용하는 것은 저작권 위반이 아니라고 규정하고 있기 때문.
