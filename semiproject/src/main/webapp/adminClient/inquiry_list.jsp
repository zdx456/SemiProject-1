...
<div class="top_wrap">
	<div class="admin_notice admin_inquiry">
		...
		<div class="pagination">
			<%if(p > 1){ %>
				<%if(searchAll){ %>
				<a href="<%=request.getContextPath()%>/adminClient/inquiry_list.jsp?p=1&s=<%=s%>&option=<%=option%>&keyword=<%=keyword%>">&laquo;</a>
				<%} else if(sort){ %>
				<a href="<%=request.getContextPath()%>/adminClient/inquiry_list.jsp?p=1&s=<%=s%>&type=<%=type%>">&laquo;</a>
				<%} else { %>
				<a href="<%=request.getContextPath()%>/adminClient/inquiry_list.jsp?p=1&s=<%=s%>">&laquo;</a>
				<%} %>
			<%} %>
			
			<%if(startBlock > 1){ %>
				<%if(searchAll || search){ %>
				<a href="<%=request.getContextPath()%>/adminClient/inquiry_list.jsp?p=<%=startBlock-1%>&s=<%=s%>&option=<%=option%>&keyword=<%=keyword%>">&lt;</a>
				<%} else if(sort){ %>
				<a href="<%=request.getContextPath()%>/adminClient/inquiry_list.jsp?p=<%=startBlock-1%>&s=<%=s%>&type=<%=type%>">&lt;</a>
				<%} else { %>
				<a href="<%=request.getContextPath()%>/adminClient/inquiry_list.jsp?p=<%=startBlock-1%>&s=<%=s%>">&lt;</a>
				<%} %>
			<%} %>
			...
			<%for(int i=startBlock; i <= endBlock; i++){ %>
				<%if(searchAll || search){ %>
					<%if(i == p){ %>
					<a class="active" href="<%=request.getContextPath()%>/adminClient/inquiry_list.jsp?p=<%=i%>&s=<%=s%>&option=<%=option%>&keyword=<%=keyword%>"><%=i%></a>	
					<%} else { %>
					<a href="<%=request.getContextPath()%>/adminClient/inquiry_list.jsp?p=<%=i%>&s=<%=s%>&option=<%=option%>&keyword=<%=keyword%>"><%=i%></a>
					<%} %>
				<%} else if(sort){ %>
					<%if(i == p){ %>
					<a class="active" href="<%=request.getContextPath()%>/adminClient/inquiry_list.jsp?p=<%=i%>&s=<%=s%>&type=<%=type%>"><%=i%></a>	
					<%} else { %>
					<a href="<%=request.getContextPath()%>/adminClient/inquiry_list.jsp?p=<%=i%>&s=<%=s%>&type=<%=type%>"><%=i%></a>
					<%} %>
				<%} else { %>
					<%if(i == p){ %>
					<a class="active" href="<%=request.getContextPath()%>/adminClient/inquiry_list.jsp?p=<%=i%>&s=<%=s%>"><%=i%></a>	
					<%} else { %>
					<a href="<%=request.getContextPath()%>/adminClient/inquiry_list.jsp?p=<%=i%>&s=<%=s%>"><%=i%></a>
					<%} %>
				<%} %>
			<%} %>
			...
			<%if(endBlock < lastPage){ %>
				<%if(searchAll || search){ %>
				<a href="<%=request.getContextPath()%>/adminClient/inquiry_list.jsp?p=<%=endBlock+1%>&s=<%=s%>&option=<%=option%>&keyword=<%=keyword%>">&gt;</a>
				<%} else if(sort){ %>
				<a href="<%=request.getContextPath()%>/adminClient/inquiry_list.jsp?p=<%=endBlock+1%>&s=<%=s%>&type=<%=type%>">&gt;</a>
				<%} else { %>
				<a href="<%=request.getContextPath()%>/adminClient/inquiry_list.jsp?p=<%=endBlock+1%>&s=<%=s%>">&gt;</a>
				<%} %>
			<%} %>
			
			<%if(p < lastPage){ %>
				<%if(searchAll || search){ %>
				<a href="<%=request.getContextPath()%>/adminClient/inquiry_list.jsp?p=<%=lastPage%>&s=<%=s%>&option=<%=option%>&keyword=<%=keyword%>">&raquo;</a>
				<%} else if(sort){ %>
				<a href="<%=request.getContextPath()%>/adminClient/inquiry_list.jsp?p=<%=lastPage%>&s=<%=s%>&type=<%=type%>">&raquo;</a>
				<%} else { %>
				<a href="<%=request.getContextPath()%>/adminClient/inquiry_list.jsp?p=<%=lastPage%>&s=<%=s%>">&raquo;</a>
				<%} %>
			<%} %>		
		</div>
	</div>
