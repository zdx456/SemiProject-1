...
@WebServlet(urlPatterns = "/search/region_sort.svt")
public class SearchRegionSortListServlet  extends HttpServlet{
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			List<ContentsAttachmentDto> searchList = contentsAttachmentDao.searchRegionSort(p, keyword, type); 
